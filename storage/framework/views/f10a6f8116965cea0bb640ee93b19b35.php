...
<form class="text-center border border-light p-5" method="post" action="<?php echo e(route('funcionario-inserido')); ?>">
    <?php echo csrf_field(); ?>
...
</script><?php /**PATH D:\xampp\htdocs\PizzaTube\resources\views/private/form-insere-funcionario.blade.php ENDPATH**/ ?>